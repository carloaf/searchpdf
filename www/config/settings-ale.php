...
/**
 * Caminho relativo do diretório a partir do publicação (Ex: /pesquisadocof/public a partir de /var/www)
 * 
 * @param string
 * @example /pesquisadocof/public (de [http://localhost:8888]/pesquisadocof/public)
 * @uses Não colocar barra / no final do caminho
 */
$settings['path_relative'] = '/oddocs/public';
...
$lang['main_title'] = 'Execução Orçamentária e Financeira';

// Título que aparece na aba do navegador (tag HTML title) junto ao favicon
$lang['page_title'] = 'Execução Orçamentária e Financeira';
